...
RSpec.describe ImageUploader do
  ...
  it '正しい地理的情報を取得できること' do
    ...
    geocode_result = instance_double('GeocodeResult', data: {
                                       'address_components' => [
                                         { 'long_name' => '岡山県', 'types' => ['administrative_area_level_1'] },
                                         { 'long_name' => '岡山市', 'types' => ['locality'] }
                                       ]
                                     })
    ...
    expect(uploader.taken_date_time).to eq(exif_data.date_time)
  end
end
