...
module StatisticsQueryConcern
  ...
  included do
    def build_search_query
      insect_data = Insect.joins(collected_insect_images: [{ city: :prefecture }, :user])
      ...
      if current_user
        user_insect_data = insect_data.where(collected_insect_images: { user_id: current_user.id })
